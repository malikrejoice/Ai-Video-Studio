...
import { Copy, Cpu, Search, Share2, Sparkles } from 'lucide-react';
import { useToast, useVideoStore } from '@/lib/store';
...
export default function Navbar() {
  ...
  return (
    <nav className="flex h-auto flex-col gap-4 border-b border-[#1e293b]/8 bg-white/55 px-5 py-5 backdrop-blur-xl lg:h-24 lg:flex-row lg:items-center lg:justify-between lg:px-8">
      <div className="flex flex-1 items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-2 flex items-center gap-3 rounded-2xl border border-[#1d2430]/8 bg-white/70 px-4 py-3 shadow-[0_12px_34px_rgba(29,36,48,0.06)]">
            <Search className="h-4 w-4 text-[#8b95a7]" />
            <input
              type="text"
              value={searchValue}
              onChange={(e) => setSearchValue(e.target.value)}
              placeholder="Search your scenes, styles, or prompts"
      ...
      <div className="flex flex-wrap items-center gap-3 lg:ml-6 lg:justify-end">
